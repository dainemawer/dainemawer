...
With AI, I broke the feature down quickly, explored a few animation strategies, and had a working MVP. It helped us [estimate more accurately](/mastering-task-estimation) and kept pressure off me, while still delivering something that mattered.
...
I wanted to contribute something real, so I asked AI to walk me through Fueled's conventions and help with a small feature I was building alongside Konstantinos. I was nervous about that PR, and the nerves were the right instinct: code you didn't fully write still [needs reading for intent, not just correctness](/reviewing-ai-generated-code). It passed without a hitch. Small win, but a real reminder that with the right support, it's possible to stretch into unfamiliar territory and still ship solid work.

## Clearer communication under pressure

Leading a long, demanding project carries real emotional weight, and that stress has a way of creeping into how you show up in Slack, [code review](/effective-code-reviews), or a project update. I didn't want that, for myself or the team.
