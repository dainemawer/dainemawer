...
This is the part of the practice that actually changes how a review happens, and it's a small but real shift from [reviewing AI-generated code on its own terms](/reviewing-ai-generated-code). Before checking whether the code is correct line by line, check whether it satisfies the spec. Before approving the spec's own coverage, check it against the ticket or the problem it was meant to solve.
